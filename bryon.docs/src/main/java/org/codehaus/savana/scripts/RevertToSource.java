...
public class RevertToSource extends SVNScript {
    ...
    public void run()
        ...
        try {
            ...
            wcClient.doRevert(new File[]{_path}, SVNDepth.fromRecurse(false), null);
            logEnd("Do Revert");
        }
        ...
        if (sourceExists && branchExists) {
            ...
            // TODO: make sure that with HEAD, everything works okay.
            diffClient.doMerge(_path, SVNRevision.HEAD, sourceURL, wcInfo.getLastMergeRevision(), _path,
                               SVNDepth.fromRecurse(false), false, false, false, false);
            logEnd("Do merge");
            ...
            copyClient.doCopy(
                    new SVNCopySource[]{
                            new SVNCopySource(SVNRevision.UNDEFINED,
                                              wcInfo.getLastMergeRevision(),
                                              sourceURL)
                    }, _path.getAbsoluteFile(), false, false, false);
